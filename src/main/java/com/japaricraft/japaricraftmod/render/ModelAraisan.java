...
public class ModelAraisan extends ModelBase {
    ...
    public ModelAraisan() {
        ...
        this.hair_b_01.setRotationPoint(-3.5F, -5.55F, -2.6F);
        this.hair_b_01.addBox(-1.0F, -0.5F, -2.0F, 2, 7, 2, 0.0F);
        ...
        this.main_hair_l.setRotationPoint(-4.0F, -2.0F, 0.0F);
        this.main_hair_l.addBox(-4.0F, -4.0F, -1.0F, 8, 6, 1, 0.0F);
        ...
        this.hair_b_02.setRotationPoint(3.5F, -5.55F, -2.6F);
        this.hair_b_02.addBox(-1.0F, -0.5F, -2.0F, 2, 7, 2, 0.0F);
        ...
        this.neck = new ModelRenderer(this, 64, 10);
        ...
        this.main_hair_back.setRotationPoint(0.0F, -2.0F, 4.0F);
        this.main_hair_back.addBox(-4.0F, -4.0F, 0.0F, 8, 6, 1, 0.0F);
        this.setRotateAngle(main_hair_back, 0.08726646259971647F, 0.0F, 0.0F);
        this.main_hair_r = new ModelRenderer(this, 0, 34);
        this.main_hair_r.setRotationPoint(4.0F, -2.0F, 0.0F);
        this.main_hair_r.addBox(-4.0F, -4.0F, -1.0F, 8, 6, 1, 0.0F);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        Araisan araisan = (Araisan) entity;
