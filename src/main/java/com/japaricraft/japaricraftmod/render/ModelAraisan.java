...
public class ModelAraisan extends ModelBase {
    ...
    private ModelRenderer tie1;
    private ModelRenderer op_l;
    private ModelRenderer neck;
    private ModelRenderer ear_r;
    private ModelRenderer ear_l;
    private ModelRenderer hair_fh;
    private ModelRenderer hair_fh_2;
    private ModelRenderer hair_fh_3;
    private ModelRenderer hair_fh_4;
    private ModelRenderer hair_fh_5;
    private ModelRenderer hair_b_01;
    private ModelRenderer main_hair_l;
    private ModelRenderer main_hair_back;
    private ModelRenderer hair_b_02;
    private ModelRenderer main_hair_r;
    private ModelRenderer neck_a;
    private ModelRenderer ear_r_at;
    private ModelRenderer ear_l_at;
    private ModelRenderer cl_l;
    private ModelRenderer cl_r;
    private ModelRenderer skirt_2;
    private ModelRenderer tie2;
    ...
    public ModelAraisan() {
        ...
        ModelRenderer tie1_l2 = new ModelRenderer(this, 60, 29);
        tie1_l2.setRotationPoint(-0.3F, -1.89F, -1.0F);
        tie1_l2.addBox(0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F);
        ...
        ModelRenderer tie1_l1 = new ModelRenderer(this, 60, 24);
        tie1_l1.setRotationPoint(-0.1F, -0.1F, -1.0F);
        tie1_l1.addBox(0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F);
        ...
        ModelRenderer tie3 = new ModelRenderer(this, 60, 19);
        tie3.setRotationPoint(-0.5F, -2.0F, 0.0F);
        tie3.addBox(-1.0F, -1.0F, -1.0F, 2, 2, 1, 0.0F);
        ...
        this.tie1.addChild(tie1_l1);
        this.body.addChild(this.leg_l);
        this.tie1.addChild(tie3);
