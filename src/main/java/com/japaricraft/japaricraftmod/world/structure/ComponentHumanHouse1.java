...
public class ComponentHumanHouse1 extends StructureComponent {
    ...
    public ComponentHumanHouse1(int par1, Random par2Random, int par3, int par4) {
        ...
        this.boundingBox = new StructureBoundingBox(par3, par1, par4, par3 + 8, par1+9, par4 + 8);
    }
    @Override
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox) {
        ...
        this.fillWithBlocks(world, structureboundingbox, 3, 0, 3, 5, -5, 5, iblockstate,iblockstate, false);
